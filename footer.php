		...
		<div class="row foot-pad">
			...
			<div class="span5 about-text">
				...
				<p>Vitas is a Coimbatore based Real Estate Company selling plots and
					...
					the guidance of our founder, Sridevi Selvaa, we have come a long
					way by learning and understanding the real estate market. Building
					relationships and acquiring the trust of our customers is the
					reason why we have come this far.</p>
			...
			<div class="span3">
				...
				<ul class="list-info">
					<li><img src="img/icons/icon-18-address.png" alt="icon">&nbsp;
						177-178,Raju Naidu Road,<br>&nbsp;&nbsp;&nbsp;&nbsp;Sivanandha
						Colony,<br>&nbsp;&nbsp;&nbsp;&nbsp;Coimbatore-27.</li>
					<li><img src="img/icons/icon-18-phone.png" alt="icon">&nbsp;(0422)4371273,4212461</li>
					<li><img src="img/icons/icon-18-mail.png" alt="icon">&nbsp;<a
						href="info@vitasinfra.com">info@vitasinfra.com</a></li>
